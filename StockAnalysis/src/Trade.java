...
public class Trade {
    ...
    public int getHoldingPeriod() {
        ...
        return Integer.parseInt(String.valueOf((exitDate.getTime() - entryDate.getTime())/(1000 * 60 * 60 * 24)));
    }
    ...
    /**
     *
     * @param sym name of the stock
     * @param opDate entry date
     * @param entry entry price
     * @param stop stop loss
     * @param tar target
     * @param d direction(long or short)
     */
